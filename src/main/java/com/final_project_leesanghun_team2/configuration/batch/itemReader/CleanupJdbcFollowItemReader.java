...
@Component
@Slf4j
public class CleanupJdbcFollowItemReader implements ItemReader<List<Long>> {

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public CleanupJdbcFollowItemReader(JdbcTemplate jdbcTemplate) {
	...
	public List<Long> read() throws Exception {
		...
		List<Long> ids = jdbcTemplate.queryForList(
				"SELECT follow_id FROM follow WHERE deleted_at IS NOT NULL AND deleted_at < ?",
