...
@Component
@Slf4j
public class CleanupJdbcCommentItemReader implements ItemReader<List<Long>> {

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public CleanupJdbcCommentItemReader(JdbcTemplate jdbcTemplate) {
	...
	public List<Long> read() throws Exception {
		...
		List<Long> ids = jdbcTemplate.queryForList(
				"SELECT comment_id FROM comment WHERE deleted_at IS NOT NULL AND deleted_at < ?",
