...
@Component
@Slf4j
public class CleanupJdbcTagPostPostItemReader implements ItemReader<List<Long>> {

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public CleanupJdbcTagPostPostItemReader(JdbcTemplate jdbcTemplate) {
	...
	public List<Long> read() throws Exception {
		...
		List<Long> ids = jdbcTemplate.queryForList(
				"SELECT tag_post_id FROM tag_post WHERE deleted_at IS NOT NULL AND deleted_at < ?",
